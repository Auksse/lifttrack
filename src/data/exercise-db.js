/**
 * Unified exercise database — 216 exercises.
 *
 * Auto-converted from the legacy `window.LIFTTRACK_EXERCISE_DB` global to an
 * ES module. Regenerate the source data with: node data/gen-exercise-db.js
 *
 * Each record carries the muscles it trains with a 1-5 involvement score,
 * which is what drives both the muscle map and the recovery model.
 */
